...
export default function Login() {
    ...
    async function handlePostPaciente() {

        let objPaciente: PacienteProps = {
            nome: txtName,
            senha: txtPassword,
            cpf: txtDocument,
            email: txtEmail
        ...
        setLoading(true);
        try {
            const response = await api.post(`/Paciente`, objPaciente);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <MyButton title='Salvar' onPress={handlePostPaciente} />
